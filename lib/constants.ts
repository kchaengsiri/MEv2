...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      'A centralized IoT command center for commercial energy optimization, featuring real-time device orchestration, predictive data modeling, and automated energy-saving scenarios.',
  ...
  },
  {
    ...
    description:
      'An internal productivity suite designed to streamline digital marketing workflows for the J.League. It centralizes match data and brand assets, featuring a dynamic graphics engine that automatically generates platform-specific matchday posters and promotional media.',
    badges: [
      'React',
      'Next.js',
      'Redux',
  ...
  },
  {
    ...
    description:
      'A domain-specific conversational AI engineered for football analytics. Utilizing an advanced RAG architecture, it ingests human-curated, authoritative data to deliver highly precise, hallucination-free insights regarding teams, players, and match statistics.',
    badges: [
      'Python',
      'PostgreSQL',
      'PG Vector',
...
export const HERO_TECHS = ['Django', 'FastAPI', 'Node.js', 'Angular', 'React', 'Next.js', 'Vite'];
